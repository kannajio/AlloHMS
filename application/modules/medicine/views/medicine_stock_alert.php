            ...
            <div class="modal-body row">
                <form role="form" action="medicine/addNewMedicine" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control default-date-picker" name="e_date" id="exampleInputEmail1" value='' placeholder="" data-date-container='#myModal'>
                    </div>
                    <div class="form-group col-md-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editMedicineForm" class="clearfix" action="medicine/addNewMedicine" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"> <?php echo lang('expiry_date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="e_date" id="exampleInputEmail1" value='' placeholder="" data-date-container='#myModal2'>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="min_stock"> <?php echo 'Minimum Stock'; ?></label>
                        <input type="text" class="form-control" name="min_stock" id="min_stock" value='' placeholder="">
