                ...
                <section class="">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                      <!--  <li class="active"> <?php echo lang('patient'); ?> <?php echo lang('name'); ?><span class="label pull-right r-activity"><?php echo $patient->name; ?></span></li> -->
                        <li>  <?php echo lang('patient_id'); ?> <span class="label pull-right r-activity"><?php echo $patient->serial_id; ?></span></li>
            ...
            <section class="panel-body">   
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#checkup"><?php echo lang('checkup'); ?> History</a>
                        </li>
                        <li class="">
                ...
                <div class="panel">
                    <div class="tab-content">
                        <div id="checkup" class="tab-pane">
                            <div class="">
                                <?php if (!$this->ion_auth->in_group('Patient')) { ?>
                                    <div class=" no-print">
                                        <a class="btn btn-info btn_width btn-xs" target="_blank" data-toggle="modal" href="checkup/add_new">
                                            ...
                                            <?php foreach ($checkups as $cp) { ?>
                                                <tr class="">
                                                    ...
                                                    <?php if (!$this->ion_auth->in_group('Patient')) { ?>
                                                        ...
                                                        <a href="checkup/add_new/<?php echo $cp->id; ?>" class="btn btn-info btn-xs btn_width" target="_blank" title="<?php echo lang('edit'); ?>" ><i class="fa fa-edit"> </i></a>   
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="#" onclick="viewCheckup(<?php echo $cp->id; ?>); return false;" class="btn btn-info btn-xs btn_width" target="_blank" style="background:#53bee6; border:1px solid #53bee6;" title="<?php echo lang('view'); ?>" ><i class="fa fa-eye"> </i></a>   
                                                    <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
