    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="doctor/addNew" class="clearfix" method="post" id="addUserForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="profile" class="manda-label"><?php echo lang('profile'); ?><span class="manda-span">*</span></label>
                        <input type="text" class="form-control" name="profile" id="profile" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div id="permission" class="">
                            <div class="form-group">
                                ...
                                <?php foreach ($permissions as $permission) {
                                     if ($permission->feature == 'Dashboard' || $permission->feature == 'Patient' || $permission->feature == 'Appointment' || $permission->feature == 'Patient Encounter' || $permission->feature == 'Prescription'|| $permission->feature == 'Report' || $permission->feature == 'Email'|| $permission->feature == 'Lab') {
                                    ?>
                                    <div class="col-md-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editDoctorForm" class="clearfix editUserForm" action="doctor/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="name" class="manda-label"><?php echo lang('name'); ?><span class="manda-span">*</span></label>
