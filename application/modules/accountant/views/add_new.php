                                    ...
                                    <form role="form" action="accountant/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div id="permission" class="">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $acc_permission = explode(",", $accounts_permissions->permissions);

                                                foreach ($permissions as $permission) {
                                                    if ($permission->feature == 'Dashboard' || $permission->feature == 'Patient' || $permission->feature == 'Finance' || $permission->feature == 'Report' || $permission->feature == 'Email') {
                                                        ?>
                                                        <div class="col-md-6">
                                                            ...
                                                            if (empty($accountant->id)) {
                                                                ...
                                                                if (in_array($permission->feature, $acc_permission)) {
                                                                    echo 'checked';
                                                                }
                                                            }
                                                            ?>
