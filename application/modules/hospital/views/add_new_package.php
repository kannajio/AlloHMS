                        ...
                        <form role="form" action="hospital/package/addNew" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <br>
                                    <input type='checkbox' value = "human_resource" name="module[]" <?php
                                    if (!empty($package->id)) {
                                        if (in_array('human_resource', $modules1)) {
                                            echo 'checked';
                                        }
                                    } else {
                                        echo 'checked';
                                    ...
                                    <br>
                                    <input type='checkbox' value = "checkup" name="module[]" <?php
                                    if (!empty($package->id)) {
                                        if (in_array('checkup', $modules1)) {
                                            echo 'checked';
                                        }
                                    } else {
                                        echo 'checked';
                                    ...
                                    <br>
                                    <input type='checkbox' value = "camp" name="module[]" <?php
                                    if (!empty($package->id)) {
                                        if (in_array('camp', $modules1)) {
                                            echo 'checked';
                                        }
                                    } else {
                                        echo 'checked';
                                    ...
                                    ?>> <?php echo lang('camp'); ?>
                                    <br>
                                    <input type='checkbox' value = "risk" name="module[]" <?php
                                    if (!empty($package->id)) {
                                        if (in_array('risk', $modules1)) {
                                            echo 'checked';
                                        }
                                    } else {
                                        echo 'checked';
