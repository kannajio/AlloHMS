                        ...
                        foreach ($packages as $package) {
                            ...
                            <tr class="">
                                ...
                                <td class="center" style="text-transform: capitalize;">
                                    <?php
                                    $all_modules = array('accountant', 'appointment', 'lab', 'bed', 'department', 'doctor', 'donor', 'finance', 'pharmacy', 'laboratorist', 'medicine', 'nurse', 'patient', 'pharmacist', 'prescription', 'receptionist', 'report', 'sms', 'notice', 'email', 'payroll');
