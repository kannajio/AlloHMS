...
class Meeting extends MX_Controller {
    ...
    function __construct() {
        ...
        if (!$this->ion_auth->in_group(array('admin', 'Doctor', 'Patient','Nurse'))) {
    ...
    function jitsi() {
        ...
        $this->appointment_model->updateLive($appointment_id, $livedata);
    ...
    function instantLive() {
        ...
        if ($this->ion_auth->in_group(array('Doctor','Nurse'))) {
