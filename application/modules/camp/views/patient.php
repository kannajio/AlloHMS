...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="">
<input type="hidden" id="camp_id" value="<?php echo $campid; ?>">
            <header class="panel-heading">
                <?php echo '<b>'. $camp->camp_name . '</b> : ' . lang('patient'); ?>s
                <div class="col-md-4 no-print pull-right"> 
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group pull-right">
                            <a href="camp/addNewPatient/<?php echo $campid; ?>" class="btn green btn-xs btn_width" title="Add Patient" ><?php echo lang('add_new'); ?></a>
                        </div>
                    </a>
                </div>
            </header>
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" readonly name="serial_id" id="exampleInputEmail1" value='' placeholder="">
                    </div> -->
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            //$('#editPatientForm').find('[name="serial_id"]').val(response.patient.serial_id).end()
            ...
            $('#editPatientForm').find('[name="campid"]').val(campid).end()
            ...
            if (response.doctor !== null) {
                var option1 = new Option(response.doctor.name + ' (Id: ' + response.doctor.serial_id + ')', response.doctor.id, true, true);
            } else {
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $.ajax({
            ...
            $('.patientIdClass').append(response.patient.serial_id).end()
...
<script>
    ...
    $(document).ready(function () {
        var table = $('#editable-sample').DataTable({
            ...
            "ajax": {
                <?php if($type) { ?>
                    url: "patient/getPatient/"+<?php echo $campid; ?>+"/"+<?php echo $type; ?>,
                <?php } else { ?>
                    url: "patient/getPatient/"+<?php echo $campid; ?>,
                <?php } ?>
                type: 'POST',
            },
            scroller: {
