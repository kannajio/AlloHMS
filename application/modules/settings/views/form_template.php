        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <div class="clearfix no-print col-md-8 pull-right">
                    ...
                    <a data-toggle="modal" href="settings/add_new">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($templates as $temp) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    <a href="settings/add_new/<?php echo $temp->id; ?>" class="btn btn-info btn-xs btn_width" title="<?php echo lang('edit'); ?>" ><i class="fa fa-edit"> </i></a>   
                                    <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="settings/form_delete?id=<?php echo $temp->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                </td>
                            </tr>
                        <?php } ?>
