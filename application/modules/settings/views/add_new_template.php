                        ...
                        <div class="col-lg-6">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="settings/add_new/<?php echo $temp->id; ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    foreach($fields as $field) { 
                                                        ...
                                                        <div style="height:40px;clear:both;" class="productdiv" id="<?php echo $i; ?>">
                                                            <div class="col-xs-6 col-md-6">
                                                                <select name="vitals[]" class="form-control m-bot15" required>
                                            ...
                                            <a href="javascript:void(0);" class="addmore_btn row" title="Add field" style="margin:10px; float:right; clear:both; height:40px;"><i class="fa fa-plus"></i> Add More</a>  
                                        </div>
