                        ...
                        <form role="form" class="clearfix pos form1"  id="editPaymentForm" action="finance/pharmacy/addPayment" method="post" enctype="multipart/form-data">
                            <div class="col-md-6 row">     
                                <?php if (!empty($payment->id)) { ?>
                                    <div class="col-md-8 payment pad_bot row">
                                ...
                                <div class="col-md-8 payment">
                                    <div class="form-group last">
                                        <div class="col-md-6 payment row pad_bot"> 
                                        ...
                                        <div class="col-md-9 row payment pad_bot">
                            ...
                            <div class="col-md-4 right-six">
                                ...
                                <div class="col-md-12 payment right-six">
                                    ...
                                    <div class="col-md-9"> 
                                        <select class="form-control m-bot15 js-example-basic-single selecttype dis_id" name='pay_in' id="dis_id" > 
