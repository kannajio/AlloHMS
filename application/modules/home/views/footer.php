<footer class="site-footer">
    <div class="text-center"> 
        20<?php echo date('y'); ?> &copy; <?php echo $this->db->get('settings')->row()->system_vendor; ?> by Jiovio Healthcare.
...
<script type="text/javascript" src="common/assets/jquery-tags-input/jquery.tagsinput.js"></script>
<script type='text/javascript' src='common/assets/jquery-tags-input/jquery-ui.min.js'></script>
