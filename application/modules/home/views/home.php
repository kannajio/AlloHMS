                                ...
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <section class="panel home_sec_blue">
                                        ...
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                                                $available_bed = $hrcount = $nursecount = $pharcount = $labcount = $acccount = $recepcount = 0;
                                                //HR
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('human_resource');
                                                $hrcount = $this->db->count_all_results();
                                                //Nurse
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('nurse');
                                                $nursecount = $this->db->count_all_results();
                                                //Pharmacist
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('pharmacist');
                                                $pharcount = $this->db->count_all_results();
                                                //Laboratorist
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('laboratorist');
                                                $labcount = $this->db->count_all_results();
                                                //Accountant
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('accountant');
                                                $acccount = $this->db->count_all_results();
                                                //Receptionist
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('receptionist');
                                                $recepcount = $this->db->count_all_results();

                                                $available_bed = ($hrcount + $nursecount + $pharcount + $labcount + $acccount + $recepcount);
                                                echo $available_bed;
                                                ?>
                                            </h3>
                                ...
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <section class="panel home_sec_yellow">
                                        ...
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                                                $available_bed = $totcount = $allotedcount = 0;
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('bed');
                                                $totcount = $this->db->count_all_results();

                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('alloted_bed');
                                                $allotedcount = $this->db->count_all_results();
                                                $available_bed = $totcount - $allotedcount;
                                                echo $available_bed;
                                                ?>
                                            </h3>
                                            <p><?php echo lang('bedavail'); ?></p>
                                        </div>
                                    </section>
                                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    </a>
                                    ...
                                    <section class="panel home_sec_blue">
                                        ...
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                                                $this->db->where('hospital_id', $this->session->userdata('hospital_id'));
                                                $this->db->from('in_patient');
                                                $count = $this->db->count_all_results();
                                                echo $count;
                                                ?>
                                            </h3>
                                            <p>In <?php echo lang('patient'); ?></p>
                                        </div>
                                    </section>
                                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    </a>
                                    ...
                                    <section class="panel home_sec_yellow">
                                        ...
                                        <div class="value">
                                            <h3 class="">
                                                ...
                                                $this->db->where("date = '".$date."' AND hospital_id = '".$this->session->userdata('hospital_id')."'");
                                                $this->db->from('appointment');
                                                $count = $this->db->count_all_results();
                                                echo $count;
                                                ?>
                                            </h3>
                                            <p>Out <?php echo lang('patient'); ?></p>
                                        </div>
                                    </section>
                                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    </a>
