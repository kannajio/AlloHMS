...
<html lang="en" <?php
$permission_id = $this->ion_auth->get_user_id();
$this->db->where('id', $permission_id);
$query_permission = $this->db->get('users')->row();
$permissions_check = explode(',', $query_permission->permissions);
...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="common/assets/jquery-tags-input/jquery.tagsinput.css" />
        ...
        <link rel="stylesheet" type="text/css" href="common/assets/jquery-tags-input/jquery-ui.css" />
        ...
        <section id="container" class="">
            ...
            <header class="header white-bg">
                ...
                if (!$this->ion_auth->in_group(array('superadmin'))) {
                    ...
                    //echo "<pre>"; print_r($settings->logo); exit;
                    ...
                    if($settings->logo) {
                        ?>
                        <img src="<?php echo $settings->logo; ?>" width="150" height="40">
                        <?php
                    } else {
                    ?>
                        <strong>
                ...
                <div class="nav notify-row" id="top_menu">
                    ...
                    <ul class="nav top-menu">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Bed", $permissions_check)) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Finance", $permissions_check)) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Patient", $permissions_check)) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Donor", $permissions_check)) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Medicine", $permissions_check)) { ?> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Report", $permissions_check)) { ?> 
            ...
            <!--sidebar start-->
            <aside>
                <div id="sidebar"  class="nav-collapse" style="height:800px; overflow-y:auto;">
                    <!-- sidebar menu start-->
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($this->ion_auth->in_group('admin') || in_array("Department", $permissions_check)) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Doctor", $permissions_check)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Receptionist'))) { ?>
                            <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Appointment", $permissions_check)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                            <?php if (in_array("Appointment", $permissions_check)) { ?>
                                <?php if (in_array('appointment', $this->modules)) { ?>
                                    <li class="sub-menu">
                                        <a href="javascript:;" >
                                            <i class="fa fa-clock"></i> 
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Nurse', 'Receptionist'))) { ?>
                            ...
                            ?>
                            <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Patient Encounter", $permissions_check)) { ?>
                                <?php if (in_array('encounter', $this->modules)) { ?>
                                    <li class="sub-menu">
                                        <a href="javascript:;" >
                                            <i class="fa fa-tasks"></i> 
                                            <span><?php echo lang('encounter'); ?></span>
                                        </a>
                                        <ul class="sub"> 
                                            <li><a href="encounter/ip"><i class="fa fa-list-alt"></i><?php echo lang('ip'); ?></a></li>
                                            <li><a href="encounter/op"><i class="fa fa-list-alt"></i><?php echo lang('op'); ?></a></li>
                                        </ul>
                                    </li>
                                    <?php
                                }
                        ...
                        <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Receptionist", $permissions_check) || in_array("Laboratorist", $permissions_check) || in_array("Accountant", $permissions_check) || in_array("Pharmacist", $permissions_check) || in_array("Nurse", $permissions_check)) { ?>
                            <li class="sub-menu">
                                <a href="javascript:;" >
                                ...
                                <ul class="sub">
                                    <?php if ($this->ion_auth->in_group('admin') || in_array("Human Resource", $permissions_check)) { ?>
                                        <?php if (in_array('human_resource', $this->modules)) { ?>
                                            <li><a href="human_resource"><i class="fa fa-user"></i><?php echo lang('human_resource'); ?></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                                    <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Nurse", $permissions_check)) { ?>
                                        <?php if (in_array('medicine', $this->modules)) { ?>
                                    ...
                                    ?>
                                    <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Pharmacist", $permissions_check)) { ?>
                                        <?php if (in_array('medicine', $this->modules)) { ?>
                                    ...
                                    ?>
                                    <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Laboratorist", $permissions_check)) { ?>
                                        <?php if (in_array('medicine', $this->modules)) { ?>
                                    ...
                                    ?>
                                    <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Accountant", $permissions_check)) { ?>
                                        <?php if (in_array('medicine', $this->modules)) { ?>
                                    ...
                                    ?>
                                    <?php if ($this->ion_auth->in_group('admin') ||  in_array("Human Resource", $permissions_check) || in_array("Receptionist", $permissions_check)) { ?>
                                        <?php if (in_array('medicine', $this->modules)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('Receptionist')) { ?>
                            ...
                            ?>
                            <?php if (in_array("Finance", $permissions_check)) { ?>
                                <?php if (in_array('finance', $this->modules)) { ?>
                                    <li class="sub-menu">
                                        <a href="javascript:;" >
                                            <i class="fa fa-money-check"></i>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                            <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Prescription", $permissions_check)) { ?>
                        ...
                        if ($this->ion_auth->in_group(array('Receptionist'))) {
                            if (in_array("Lab", $permissions_check)) {
                                ?>
                        ...
                        if ($this->ion_auth->in_group(array('Accountant', 'Receptionist'))) {
                            if (in_array("Finance", $permissions_check)) {
                                ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                            <?php if (in_array("Prescription", $permissions_check)) { ?>
                                <?php if (in_array('prescription', $this->modules)) { ?>
                                    <li>
                                        <a href="prescription">
                        ...
                        <?php } ?>
                        <?php
                         if ($this->ion_auth->in_group(array('admin','Accountant','human_resource'))) { 
                                if ($this->ion_auth->in_group(array('Accountant','human_resource'))) { 
                            ?>
                                    <li class="sub-menu">
                                        <a href="javascript:;" >
                                            <i class="fa fa-credit-card"></i>
                                            <span>Employee Payrolls</span>
                                        </a>
                                        <ul class="sub">
                                            <li><a  href="payroll"><i class="fa fa-credit-card"></i>Employee Payrolls</a></li>
                                            <li><a  href="payroll/mypayroll"><i class="fa fa-credit-card"></i>My Payroll</a></li>
                                        </ul>
                                    </li>
                            <?php } else { ?>
                            <li><a href="payroll"><i class="fa fa-credit-card"></i> Employee Payrolls</a></li>
                        ...
                        if (!$this->ion_auth->in_group(array('superadmin','Patient'))) {
                        ?>
                            <li><a href="payroll/mypayroll"><i class="fa fa-credit-card"></i> My Payroll</a></li>
                        <?php } } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Laboratorist'))) { ?>
                            ...
                            <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Lab", $permissions_check)) { ?>
                            ...
                            <?php if (in_array('medicine', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li><a  href="medicine/medicineExpiryAlert"><i class="fa fa-medkit"></i><?php echo lang('medicine_expiry_list'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                            ...
                            <?php if ($this->ion_auth->in_group(array('admin')) || in_array("Pharmacy", $permissions_check)) { ?>
                                ...
                                <?php if (in_array('pharmacy', $this->modules)) { ?>
                                    <li class="sub-menu">
                                        ...
                                        <ul class="sub">
                                            ...
                                            <li><a  href="finance/pharmacy/purchase"><i class="fa fa-money-check"></i> Purchase</a></li>
                                            <li><a  href="finance/pharmacy/addPurchaseView"><i class="fa fa-plus-circle"></i>Add New Purchase</a></li>
                                            ...
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist')) || in_array("Report", $permissions_check)) { ?>
                                                <li class="sub-menu">
                                                    <a href="javascript:;" >
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php
                                    if ($this->ion_auth->in_group(array('admin')) || in_array('Report', $permissions_check)) {
                                        if (in_array('report', $this->modules)) {
                                            ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            <?php if (in_array('checkup', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                        <i class="fa fa-diagnoses"></i>
                                        <span><?php echo lang('checkup'); ?></span>
                                    </a>
                                    <ul class="sub">
                                    <li><a href="checkup"><i class="fa fa-file-medical"></i><?php echo lang('checkup'); ?></a></li>
                                        <li><a  href="checkup/vitals"><i class="fa fa-clipboard-user"></i><?php echo lang('vitals'); ?></a></li>
                                        <li><a  href="checkup/symptoms"><i class="fa fa-clipboard-user"></i><?php echo lang('symptoms'); ?></a></li>
                                        <li><a href="checkup/formtemplates"><i class="fa fa-file"></i><?php echo lang('formtemplate'); ?></a></li>
                                    </ul>
                                </li> 
                                <li><a href="camp"><i class="fa fa-laptop-medical"></i> Camp</a></li>
                                <li><a href="risk"><i class="fa fa-exclamation-triangle"></i> Risk Factors</a></li>
                            <?php } ?>
                        <?php } ?>
                            ...
                            <?php if (in_array('sms', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <?php if ($this->ion_auth->in_group(array('admin')) || in_array('SMS', $permissions_check)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub"> 
                                    ...
                                    <li><a href="settings/formtemplate"><i class="fa fa-file"></i><?php echo lang('formtemplate'); ?></a></li>
                                </ul>
                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group('Pharmacist')) { ?>
                            <?php if (in_array('Medicine', $permissions_check)) { ?>
                                <?php if (in_array('medicine', $this->modules)) { ?>
                                    <li class="sub-menu">
                                        <a href="javascript:;" >
                                            <i class="fa  fa-medkit"></i>
                        ...
                        <?php if ($this->ion_auth->in_group('Nurse')) { ?>
                            <?php if (in_array('Bed', $permissions_check)) { ?>
                                <?php if (in_array('bed', $this->modules)) { ?>
                                    <li>
                                        <a href="bed" >
                                            <i class="fa fa-procedures"></i>
                            ...
                            ?>
                            <?php if (in_array('Donor', $permissions_check)) { ?>
                                <?php if (in_array('donor', $this->modules)) { ?>
                                    <li>
                                        <a href="donor" >
                                            <i class="fa fa-medkit"></i>
