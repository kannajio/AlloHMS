            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                <th> <?php echo lang('receptionid'); ?></th>
                        ...
                        <?php foreach ($receptionists as $receptionist) { ?>
                            <tr class="">
                                <td> <?php echo $receptionist->serial_id; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="clearfix" action="receptionist/addNew" method="post" id="addUserForm" enctype="multipart/form-data">
                        ...
                        <div id="permission" class="">
                            <div class="form-group">
                                ...
                                <?php foreach ($permissions as $permission) { 
                                   if ( $permission->feature == 'Patient' || $permission->feature == 'Appointment' || $permission->feature == 'Patient Encounter' || $permission->feature == 'Finance' || $permission->feature == 'Email') { 
                                    ?>
                                    <div class="col-md-6">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editReceptionistForm" class="clearfix editUserForm" action="receptionist/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="name" class="manda-label"><?php echo lang('receptionid'); ?></label>
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                $('#editReceptionistForm').find('[name="serial_id"]').val(response.receptionist.serial_id).end();
