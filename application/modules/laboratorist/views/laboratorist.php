                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($laboratorists as $laboratorist) { ?>
                            <tr class="">
                                <td> <?php echo $laboratorist->serial_id; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="laboratorist/addNew" class="clearfix" method="post" id="addUserForm" enctype="multipart/form-data">
                        ...
                        <div id="permission" class="">
                            <div class="form-group">
                                ...
                                <?php foreach ($permissions as $permission) { 
                                    if ( $permission->feature == 'Patient' || $permission->feature == 'Lab' || $permission->feature == 'Report' || $permission->feature == 'Email' || $permission->feature == 'Donor') { 
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editLaboratoristForm" class="clearfix editUserForm" action="laboratorist/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="name" class="manda-label"><?php echo lang('labid'); ?></label>
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                $('#editLaboratoristForm').find('[name="serial_id"]').val(response.laboratorist.serial_id).end()
