...
<html lang="en">
    ...
    <body class="login-body">
        ...
        <div class="container">
            ...
            <form class="form-signin" method="post" action="auth/checklogin">
                ...
                <div class="login-wrap">
                    <input type="text" class="form-control" name="identity" placeholder="Email / Mobile Number" autofocus required>
